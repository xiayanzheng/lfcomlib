...
class ErrMsg:
    do_not_input_str = "不支持输入字符"
    unable_access_this_file = "另一个程序正在使用此文件，进程无法访问。"

    def __init__(self, do_not_input_str, unable_access_this_file):
        self.do_not_input_str = do_not_input_str
        self.unable_access_this_file = unable_access_this_file
...
class SaveData():
    ...
    def ModifyExcel(self, FilePath, Filename, RowColSet, Data):
        ...
        try:
            ...
            print(ErrMsg.unable_access_this_file)
